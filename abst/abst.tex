...
\bibitem{3} 「Rubyst Magazine」,かくたに もろはし vol.54 \url{http://magazine.rubyist.net/?0021-Rspec}.
\bibitem{4} 「give IT a try」，伊藤淳一, \url{http://blog.jnito.com/entry/2015/07/13/073458}.
\end{thebibliography}
\end{flushleft}
\end{document}